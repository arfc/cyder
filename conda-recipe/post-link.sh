# This script replaces the cyder_unit_tests commands with a simple
...
mv $PREFIX/bin/cyder_unit_tests $PREFIX/bin/cyder_unit_tests_base
echo "#!/bin/bash
...
$PREFIX/bin/cyder_unit_tests_base \$*
" > $PREFIX/bin/cyder_unit_tests
chmod 755 $PREFIX/bin/cyder_unit_tests
